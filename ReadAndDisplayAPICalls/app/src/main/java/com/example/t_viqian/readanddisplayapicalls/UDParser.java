...
public class UDParser
{
    ...
    public Definition[] getDefinitionsWithJSONData(String JSONData) throws JSONException {
     ...
     */
    public JSONArray getTagsWithJSONData(String JSONData) throws JSONException {
        JSONObject obj = new JSONObject(JSONData);
     ...
     * @return the result type for a keyword.
     */
    public boolean getResultTypeByKeyword(String JSONData) throws JSONException {
        JSONObject obj = new JSONObject(JSONData);
